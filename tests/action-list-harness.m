...
int main(void)
{
    @autoreleasepool
    {
        ...
        NSArray *normalized = GonerinoUniqueBlockActions(
            @[ stock, channel, video, duplicateChannel, duplicateVideo ]);
        ...
        NSArray *merged =
            GonerinoPrependUniqueBlockActions(@[ stock, duplicateChannel ], @[ channel, video ]);
